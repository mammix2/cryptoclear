...
#ifdef Q_OS_MAC
    resize(960, 595);
    setWindowTitle(tr("Cryptoclear - MacOS wallet"));
#elif _WIN32
    resize(900, 580);
    setWindowTitle(tr("Cryptoclear - Windows wallet"));
#else
    resize(1000, 630);
    setWindowTitle(tr("Cryptoclear - Linux wallet"));
#endif
#ifndef Q_OS_MAC
...
//here    statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #101010, stop: 1 #404040);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Cryptoclear address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/toolbar_testnet"),tr("&About Cryptoclear"), this);
    aboutAction->setToolTip(tr("Show information about Cryptoclear"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Cryptoclear"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Cryptoclear client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Cryptoclear client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cryptoclear network", "", count));
}
...
{
    QString strTitle = tr("Cryptoclear") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Cryptoclear address or malformed URI parameters."));
    }
