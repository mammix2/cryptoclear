...
#if defined(NDEBUG)
# error "Cryptoclear cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Cryptoclear Signed Message:\n";
...
#ifdef ENABLE_WALLET
// cryptoclear: attempt to generate suitable proof-of-stake
...
{
    RenameThread("cryptoclear-loadblk");
